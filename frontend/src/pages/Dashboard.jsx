    ...
    <div className={`card bg-₹{color} text-white h-100 shadow-sm stat-card`}>
      <div className="card-body">
        <div className="d-flex justify-content-between align-items-start">
          <div>
            <h6 className="card-title text-uppercase opacity-75 mb-1">
              {title}
            </h6>
        ...
        {link && (
          <div className="mt-3">
            <Link
              to={link}
              className="text-white text-decoration-none opacity-75 hover-opacity-100 d-flex align-items-center"
            >
              View Details
