...
(function (ActionType) {
  ...
  ActionType[ActionType["TOAST"] = 5] = "TOAST";
  ActionType[ActionType["START_PAUSE"] = 6] = "START_PAUSE";
  ActionType[ActionType["END_PAUSE"] = 7] = "END_PAUSE";
...
var defaultTimeouts = /*#__PURE__*/new Map([['blank', 4000], ['error', 4000], ['success', 2000], ['loading', 30000]]);
...
var useToaster = function useToaster() {
  ...
  React.useEffect(function () {
    ...
    var timeouts = toasts.map(function (t) {
      var duration = t.duration - (now - t.createdAt);
  ...
  var handlers = React.useMemo(function () {
    return {
      ...
      calculateOffset: function calculateOffset(toastId, _ref) {
        var _ref$reverseOrder = _ref.reverseOrder,
...
var Indicator = function Indicator(_ref) {
  ...
  return React.createElement(IndicatorWrapper, null, React.createElement(LoaderIcon, Object.assign({}, theme)), type !== 'loading' && React.createElement(StatusWrapper, null, type === 'error' ? React.createElement(ErrorIcon, Object.assign({}, theme)) : React.createElement(CheckmarkIcon, Object.assign({}, theme))));
};
...
var enter = /*#__PURE__*/goober.keyframes( /*#__PURE__*/_templateObject$4());
var AnimatedIconWrapper = /*#__PURE__*/goober.styled('div')( /*#__PURE__*/_templateObject2$4(), enter);
...
var ToastBarBase = /*#__PURE__*/goober.styled('div', React.forwardRef)( /*#__PURE__*/_templateObject$5());
var Message = /*#__PURE__*/goober.styled('p')( /*#__PURE__*/_templateObject2$5());
...
var getAnimationStyle = function getAnimationStyle(position, visible) {
  ...
  var factor = top ? 1 : -1;
  return visible ? {
    animation: goober.keyframes(_templateObject3$2(), enterAnimation(factor)) + " 0.35s cubic-bezier(.21,1.02,.73,1) forwards"
  } : {
    animation: goober.keyframes(_templateObject4$1(), exitAnimation(factor)) + " 0.8s forwards cubic-bezier(.06,.71,.55,1)",
    pointerEvents: 'none'
  };
};
...
var ToastBar = /*#__PURE__*/React.memo(function (_ref) {
  var toast = _ref.toast,
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["toast", "options", "position"]);
  ...
  var mergeOptions = _extends({}, options, toast);
  ...
  var renderIcon = function renderIcon() {
    var icon = mergeOptions.icon,
        type = mergeOptions.type,
        iconTheme = mergeOptions.iconTheme;
  ...
  }, React.createElement(ToastBarBase, {
    ref: ref,
    className: mergeOptions.className,
    style: _extends({}, animationStyle, options.style, toast.style)
  }, renderIcon(), React.createElement(Message, {
    role: mergeOptions.role,
    "aria-live": mergeOptions.ariaLive
...
var Toaster = function Toaster(_ref) {
  ...
  return React.createElement("div", {
    ...
    return React.createElement(ToastBar, {
      ...
      position: position,
      options: _extends({}, toastOptions, toastOptions == null ? void 0 : toastOptions[t.type])
    });
  }));
};
